...
1. Then the program will take input folder that was generated by ExtractContentRefined.py
2. Enter the SPAM.label that contains both and only training and testing folder
3. After the Classifier is set, you can enter the testing folder or training folder
4. You can print the predicted label to a file
5. You can evaluate the False Positive Rate, False Negative Rate, Recall, Precision, F-Score
6. You can continue testing another folder and get back to step 4, or you can exit...

######################################################

How to use SVM.py:
   Invoke the script by command: python3 SVM.py
